...
class createAListing extends Component {
    constructor(props) {
        super(props)
        this.state = {
            inputName = "",
     ...
     <div className='createAListingForm'>
        <form onSubmit= {this.handleSUbmit}>
            <div className = "textspacing">
                Name your listing:
            <input type='text' value= {this.state.inputName} placeholder ='Item name' onChange ={this.handleItemName}/>
            </div>
            <div className = "textSpacing">
            Write a description here
            <input type='text' value= {this.state.inputDesc} placeholder ='Item description' onChange ={this.handleItemDesc}/>
            </div>
            <div className = "textSpacing">
            How much would you like to sell it for?
            <input type='text' value= {this.state.inputPrice} placeholder ='Item price' onChange ={this.handleItemPrice}/>
           </div>
           <div className="textspacing">
               Upload an image:
